...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        resume=False,
        wandb_enabled=True,
        exp_name="pi05_ur3_pvi_dinov2_h50_almonds_4obj",
    ),
    TrainConfig(
    ...
    TrainConfig(
        ...
        resume=False,
        wandb_enabled=True,
        exp_name="pi05_ur3_pvi_hpr_h50_almonds_4obj",
    ),
    TrainConfig(
    ...
    TrainConfig(
        ...
        resume=False,
        wandb_enabled=True,
        exp_name="pi05_ur3_pvi_siglip_h50_almonds_4obj",
    ),
    TrainConfig(
    ...
    TrainConfig(
        ...
        resume=False,
        wandb_enabled=True,
        exp_name="pi05_ur3_pvi_clip_h50_almonds_4obj",
    ),
    TrainConfig(
    ...
    TrainConfig(
        ...
        resume=False,
        wandb_enabled=True,
        exp_name="pi05_ur3_pvi_r3m_h50_almonds_4obj",
    ),
    TrainConfig(
