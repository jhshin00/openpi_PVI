...
def make_ur3_example() -> dict:
    """Creates a random input example for the UR3 policy."""
    return {
...
class UR3Inputs(transforms.DataTransformFn):
    """Convert UR3 environment observations to the model input format."""
...
class UR3Outputs(transforms.DataTransformFn):
    """Convert model outputs back to the 7D UR3 action space."""
