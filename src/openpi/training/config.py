...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_libero_pvi_infer_hpr",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
            ...
            pvi_aux_encoder_name="/data/jhshin/openpi/hpr_checkpoints/hpr_fullfinetune_base_lang_trace_negative_mod.ckpt",
            pytorch_compile_mode=None,
        ),
        data=LeRobotLiberoDataConfig(
            repo_id="physical-intelligence/libero",
        ...
        resume=False,
        wandb_enabled=False,
        exp_name="pi05_libero_pvi_hpr_infer",
    ),
    #
  ...
  TrainConfig(
    ...
    # DINOv2 auxiliary encoder (from pi05_libero)
    TrainConfig(
        name="pi05_libero_pvi_from_pi05_libero_dinov2",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
        ...
        overwrite=False,
        resume=False,
        exp_name="pi05_libero_pvi_from_pi05_libero_dinov2",
    ),
    # SigLIP auxiliary encoder (from pi05_libero)
    TrainConfig(
        name="pi05_libero_pvi_from_pi05_libero_siglip",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
        ...
        overwrite=False,
        resume=False,
        exp_name="pi05_libero_pvi_from_pi05_libero_siglip",
    ),
    # HPR auxiliary encoder (from pi05_libero)
    TrainConfig(
        name="pi05_libero_pvi_from_pi05_libero_hpr",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
        ...
        overwrite=False,
        resume=False,
        exp_name="pi05_libero_pvi_from_pi05_libero_hpr",
    ),
    # CLIP auxiliary encoder (from pi05_libero)
    TrainConfig(
        name="pi05_libero_pvi_from_pi05_libero_clip",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
        ...
        overwrite=False,
        resume=False,
        exp_name="pi05_libero_pvi_from_pi05_libero_clip",
    ),
    # R3M auxiliary encoder (from pi05_libero)
    TrainConfig(
        name="pi05_libero_pvi_from_pi05_libero_r3m",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
