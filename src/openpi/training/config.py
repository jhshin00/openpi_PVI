...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotUR3DataConfig(
            repo_id="ur3_dataset_9obj_0409_gripper",
            lerobot_root="./datasets",
            assets=AssetsConfig(assets_dir="./assets/pi05_ur3_pvi"),
            base_config=DataConfig(prompt_from_task=True),
        ),
        ...
        resume=False,
        wandb_enabled=True,
        exp_name="pi05_ur3_pvi_dinov2_h50_9obj_0409_gripper",
    ),
    TrainConfig(
    ...
    TrainConfig(
        ...
        resume=False,
        wandb_enabled=True,
        exp_name="pi05_ur3_pvi_hpr_h50_9obj_0409_gripper",
    ),
    TrainConfig(
    ...
    TrainConfig(
        ...
        resume=False,
        wandb_enabled=True,
        exp_name="pi05_ur3_pvi_siglip_h50_9obj_0409_gripper",
    ),
    TrainConfig(
    ...
    TrainConfig(
        ...
        resume=False,
        wandb_enabled=True,
        exp_name="pi05_ur3_pvi_clip_h50_9obj_0409_gripper",
    ),
    TrainConfig(
    ...
    TrainConfig(
        ...
        resume=False,
        wandb_enabled=True,
        exp_name="pi05_ur3_pvi_r3m_h50_9obj_0409_gripper",
    ),
    TrainConfig(
